...
#' @param group Group for which posterior predictions will be generated. If `NULL` (default), posterior predictions will be generated for fixed effect. If `"te"`, predictions will be generated for translation equivalents. If `"child_id"`, predictions will be generated for participants.
...
#' @param group Group level for which posterior predictions are generated. Takes `"te"` or `"child_id"` as values.
