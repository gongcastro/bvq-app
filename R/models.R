...
get_posterior_draws <- function(model,
    ...
    str_repl <- c(
        ...
        "b_age_std:lp1" = "Group \u00d7 Dominance",
        "b_age_std:dominance1" = "Group \u00d7 Dominance",
        "b_lp1:dominance1" = "Group \u00d7 Dominance",
        "b_age_std:lp1:dominance1" = "Age \u00d7 Group \u00d7 Dominance"
    )
...
posterior_predictions <- function(model, data, ...) {
    ...
    saveRDS(posterior_draws, "bvq-app/data/predictions.rds")
